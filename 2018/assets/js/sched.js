jQuery(document).ready(function ($) {
    ...
    SchedulePlan.prototype.openModal = function (event) {
        ...
        var descriptions = {
            ...
            "lightning1": "<strong>Information Handshake</strong><br/>Nisha Chaganlal<p>Come learn how important it is to acknowledge information received and how to check if what we have done actually works as a way to remove toil on having to deal with bugs and repeated tickets to have to handle the same thing all over again. If the Internet does it, why shouldn’t we?</p><strong>5 disciplines that could transform your team (and your life)</strong><br/>Luke Barton<p>An inspirational, whirlwind tour of a practical framework that you and your team can begin mastering today. You’ll see ideas from several books brought together in a rapid-fire presentation that will give you plenty of food for thought!</p><strong>Principles</strong><br/>Paul Grayson<p>I'll talk about the principles I try to apply to my work: to reduce toil, make better decisions, be more effective and lead us to better outcomes.This is no magic bullet. These principles are mine and YMMV :-)</p>",
            "lightning2": "<strong>How we deal with production fails in EU</strong><br/>Misha Doronin<p>Production is not perfect. Networks lose packets, developers break carrier APIs, bugs go live.  S**** happens. Come learn how the EU platform folks deal with the eventualities that plague a high traffic system.</p><strong>Going Beyond Fun-Driven Development</strong><br/>Artemij Fedosejev<p>You’ve got into software development because it’s fun. Now it’s time to get serious about it. This talk will inspire you and show you how to build the mindset of an educated and disciplined software developer - the one that your company aspires to have.</p> <strong>Microservice generator - From scratch to deploy in a blink</strong><br/>Fabio Gariglio<p>The birth of a new service is such an exciting event! But there is no much fun in bootstrapping a service. Wouldn't be great if that tedious routine was a matter of seconds? Come learn how that's just a thing of the past!</p> <strong>Can you spot the difference?</strong><br/>Kannappan Somasundaram<p>We built a comparison framework to capture the differences between old and new journey planners. Come find out how it enabled us to find missing features, defects, served as a reporting tool and helped us to migrate.</p>",
            "lightning3": "<strong>Reducing our Toil with Environment Dashboard</strong><br/>Wojciech Kotlarski<p>In Fusion we own a lot of services, including legacy ones, which makes keeping healthy test environments difficult. I will talk about how the creation of Environment Dashboard increased the visibility of issues in the environments and sped up the detection of problematic services.</p><strong>How we made requirement analysis transparent</strong><br/>Janos Ver<p>One of the pillars of Scrum is transparency. We wanted to extend that to requirement analysis too. In this talk I will explain how we did it.</p><strong>How to reduce toil by ignoring your lying brain</strong><br/>John Wiles<p>We all suffer from some cognitive biases, and left unchecked these can lead to us toiling away on the wrong solutions to the wrong problems. In this talk we’ll get to know some of the more common brain problems - and some techniques that can help you get past them.</p>"
        }
